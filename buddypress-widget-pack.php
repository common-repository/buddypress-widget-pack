<?php
/*
Plugin Name: Buddypress Widget Pack
Description: A widget pack for Buddypress (works great with Tabbed Widgets plugin)
Version: 1.1
Requires at least: BuddyPress 1.2
Tested up to: BuddyPress 1.2 + wpmu 2.9.1
License: GNU General Public License 2.0 (GPL) http://www.gnu.org/licenses/gpl.html
Author: Damon Cook
Author URI: http://commons.esc.edu/damon-cook/
Plugin URI:http://commons.esc.edu/damon-cook/
Site Wide Only: false
/

*/
/***
	Thanks to WPMU.org and Sarah Gooding for providing most of the code, as I just widgetized it ;) , see:
	http://wpmu.org/how-to-create-a-gallery-of-members-avatars-in-buddypress/
	http://wpmu.org/display-friend-count-and-recent-connections-in-the-buddypress-sidebar/

    Copyright (C) 2010 Damon Cook
